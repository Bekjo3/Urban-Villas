...
const Footer = ({
  ...
  const featuresSubCategoriesStyle = useMemo(() => {
    return {
      height: propHeight,
    };
  }, [propHeight]);
  ...
  return (
    ...
    >
      <footer
        className="flex flex-row items-start justify-start gap-[195px] text-left text-5xl text-gray-black font-body-regular-400 md:flex-col md:gap-[50px] sm:flex-col sm:gap-[50px]"
        style={footerStyle}
      >
        ...
        <div className="w-[173px] h-[248px] flex flex-col items-start justify-start gap-[32px]">
          ...
          <div
            className="self-stretch h-[184px] flex flex-col items-start justify-start gap-[16px] text-base text-gray-500"
            style={featuresSubCategoriesStyle}
          >
